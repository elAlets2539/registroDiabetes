...
class Secc4_3: UIViewController, UITextViewDelegate {
    ...
    func nextView() {
        ...
        let vc = storyboard?.instantiateViewController(withIdentifier: "Secc4_4") as? Secc4_4
    ...
    func saveAnswers() {
        ...
        for palabra in tf3.text {
            
            if palabra != " " {
                juan += String(palabra)
            } else {
                CubetaDePreguntas.preguntasSecc4_3.append(juan)
                juan = ""
            }
